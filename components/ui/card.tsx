...
import { brutalShadow } from "@/components/ui/brutal"
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-heading text-base uppercase leading-snug font-black tracking-tight group-data-[size=sm]/card:text-sm",
        className
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center border-t-4 border-foreground bg-muted p-(--card-spacing)",
        className
      )}
      {...props}
    />
